    ...
    return (
      <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center font-['Manrope']">
        <div className="text-center max-w-md">
          <img src={cartEmptyImg} className="w-20 mx-auto mb-6 opacity-70" />
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            {cart.items.map((item) => (
              ...
              >
                <div className="flex gap-5">
                  ...
                  {/* IMAGE */}
                  <div className="w-28 h-24 rounded-xl overflow-hidden bg-[#F9FAFB]">
                    {item.image ? (
                      <img
                        src={item.image}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-[#ECECEC] hover:bg-[#F3F4F6]"
                      >
                        -
                      </button>
          ...
          <div className="bg-white border border-[#ECECEC] rounded-[24px] p-6 h-fit sticky top-24">
            ...
            <Link
              to="/home"
              className="block text-center mt-4 text-sm text-[#6B7280] hover:text-[#111111]"
            >
